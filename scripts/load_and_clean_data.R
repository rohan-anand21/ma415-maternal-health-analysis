...
#natality_data_cleaned_2021 <- clean_data(natality_csv_2021, columns_to_remove)
#natality_data_cleaned_historical <- clean_data(natality_csv_historical, columns_to_remove)
